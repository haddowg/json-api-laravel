...
/**
 * A standalone serializer for the `jobs` type — no resource, no endpoints (an empty
 * operations allow-list, the standalone default). The async write witness
 * ({@see \haddowg\JsonApiLaravel\Tests\Conformance\AsyncWriteConformanceTestCase}) renders
 ...
 * server (`serializerFor('jobs')`) — the twin of the Symfony bundle's async witness.
 */
#[AsJsonApiSerializer(type: 'jobs')]
final class JobSerializer extends AbstractSerializer
{
