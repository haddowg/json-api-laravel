 ...
 * 0118–0121), the byte-compat twin of the bundle example's `ReleaseResource`,
 * exercising all three composite kinds on one resource:
 *
 ...
 *
 * Each attribute is stored as a single `json` column (`mc_releases`) / one array
...
final class ReleaseResource extends AbstractResource
{
    ...
    public function fields(): array
    {
        return [
            Id::make(),
            Str::make('catalogNumber')->storedAs('catalog_number')->required()->maxLength(40)->sortable(),
