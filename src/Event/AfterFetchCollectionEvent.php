 ...
 * {@see $items} is the materialized page/collection. A listener may **replace**
 * the response via {@see setResponse()}; the handler reads the (possibly replaced)
 * {@see response()} back. Routed to {@see \haddowg\JsonApiLaravel\Hook\ResourceLifecycleHooksInterface::afterFetchCollection()}.
 */
