...
/**
 * One server's worth of OpenAPI metadata, assembled by the {@see MetadataSource} into
 * a plain immutable carrier the core {@see \haddowg\JsonApi\OpenApi\OpenApiProjector}
