...
final class MetadataSource
{
     ...
     * from the live registry the {@see \haddowg\JsonApiLaravel\Server\ServerFactory} built
     * (data-driven from `jsonapi.profiles`), never hardcoded — so trimming the config
