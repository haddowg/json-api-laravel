 ...
 *
 * A custom application paginator that neither self-describes nor matches a built-in is
 * treated as the count-based {@see PaginatorKind::Page} — the JSON:API-conventional
 * default — rather than throwing, so a documented surface never fails to generate over
