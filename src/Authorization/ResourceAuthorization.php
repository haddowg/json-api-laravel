...
final readonly class ResourceAuthorization
{
     ...
     * @param array<string, string|bool> $abilities    per-operation ability override keyed by {@see Operation} case value
     ...
     * disable the check, `true` to document it as externally-secured without the package
     * enforcing it, or `null` when the operation carries no override (the caller falls back
     * to the policy-convention default).
     */
    public function ability(Operation $operation): string|bool|null
    {
