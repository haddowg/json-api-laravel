 ...
 * {@see MetaResponse} AND the attribute declares the matching `outputMeta` flag, so the
 * declared body shape agrees with the projected shape — discovery accepts it.
 *
 * @internal
 */
#[AsJsonApiAction(type: 'guarded', path: 'meta-with-flag', outputMeta: true)]
