...
/**
 * The `authors` resource for the Eloquent blog fixture — a leaf type and one member of a
 * {@see Post}'s polymorphic relations. Its object-aware
 * {@see DiscriminatesBlogMember::getType()} lets the morph resolver pick it for an
 * {@see Author} model.
 */
