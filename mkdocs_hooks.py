...
1. The docs link into this repository with relative paths (``../workbench/…``,
...
_PACKAGE_BLOB = "https://github.com/haddowg/json-api-laravel/blob/main/"
_CORE_DOCS = "https://github.com/haddowg/json-api/blob/main/docs/"
_CORE_PAGES = "https://haddowg.github.io/json-api/"

# ](../…/<repo path outside docs/>)  ->  package GitHub blob URL
_REPO_LINK = re.compile(
    r"\]\((?:\.\./)+((?:workbench|src|tests|config|bin|composer|phpunit|Dockerfile|compose|LICENSE|CONTRIBUTING)[^)]*)\)"
)
...
def on_page_markdown(markdown, **kwargs):
    markdown = _REPO_LINK.sub(rf"]({_PACKAGE_BLOB}\1)", markdown)
